...
> Help me with your referral [Link](https://t.me/SimonsCatApp_bot/game?startapp=kentId6713068747)
...
```json
{
  ...
  "country_time": "en-US",
  "isDoTasks": false,
  "amountOfEnergyLimitBoostUpgrade": 10,
  "amountOfMineBoostUpgrade": 10,
  "amountOfMultitapBoostUpgrade": 10,
...
> To run the bot, use the following command: `cd "simon-s-cat-fun-time-main/simon's cat fun time"; node meomundep`
